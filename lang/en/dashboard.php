...
return [
    ...
    'instructions_split' => 'Split: this tool will ask for a PDF file and entrance of page range you want your PDF to be split into. Result is PDF file split in given range',
    ...
    'instructions_PDFtoImg' => 'PDF to Images: this tool will ask you for a PDF file that will be converted to .zip of images',
