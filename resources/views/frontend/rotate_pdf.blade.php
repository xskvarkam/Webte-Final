    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('pdf.rotate.process') }}" enctype="multipart/form-data">
            ...
            <div class="form-group" x-data="{ fileName: '' }">
                <label for="pdf" class="mb-2 block">{{ __('pdf_rotate.select_pdf') }}</label>
                ...
                <div class="upload-row bg-gray-100 border border-gray-300 rounded px-3 py-2">
                    ...
                    <span x-text="fileName || '{{ __('pdf_rotate.no_file') }}'" class="file-info"></span>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="pages" name="pages" placeholder="{{ __('pdf_rotate.pages_placeholder') }}" required>
            </div>
